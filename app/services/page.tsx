        ...
        {services.map((service, i) => (
          <div key={service.title} id={service.slug} className="scroll-mt-24">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 sm:gap-12 items-center">
              {/* Photo */}
              <div className={`relative aspect-[3/4] w-full max-w-sm mx-auto md:max-w-none md:mx-0 overflow-hidden rounded-3xl shadow-lg ${i % 2 === 1 ? "md:order-2" : ""}`}>
                <Image
                  src={service.image}
                  alt={`${service.title} at OSPRE PT in Nyack, NY`}
                  fill
              ...
              <div className={`flex flex-col gap-6 ${i % 2 === 1 ? "md:order-1" : ""}`}>
                ...
                <div className="bg-slate-50 rounded-2xl p-6">
                  ...
                  <a
                    href="tel:8456341625"
                    className="inline-flex items-center gap-2 mt-6 bg-brand-deep hover:bg-brand-mid text-white text-sm font-semibold px-5 py-2.5 rounded-full transition-all"
                  >
                    <Phone size={14} />
                    Call to Book
                  </a>
